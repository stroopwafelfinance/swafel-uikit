...
<path data-name="layer1"
  ...
  fill="#EC9333"></path>
  <path data-name="layer2" fill="#EC9333" d="M12.918 33.622l7.778-7.778 7.927 7.926-7.779 7.778z"></path>
  <path data-name="layer1" fill="#EC9333" d="M23.547 22.96l7.92-7.92 7.926 7.927-7.92 7.92zM18 44.4l-8-8-5.4 5.5-.8.5a30 30 0 0 0 6.1 10zm5.55-.078l7.778-7.778 7.806 7.806-7.778 7.778z"></path>   </Svg>
  );
};
